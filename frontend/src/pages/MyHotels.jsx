...
import {getMyHotels, deleteHotel} from '../api-services/hotel.api-services.js';
...
export default function MyHotels(){
    ...
    const deleteHotelClick = (hotelId) => {
        mutate(hotelId);
    }
                        ...
                        <div key={index} className="border border-gray-300 px-10 py-6 mb-12">
                            <div className="flex justify-between">
                                ...
                                <div className="flex">
                                    ...
                                    {/* Delete Hotel Button */}
                                    <button className='self-start' onClick={() => deleteHotelClick(hotelData.data._id)}>
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className="flex gap-1">
                                    ...
                                    {hotel.starRating || 'No'} star rating
                                </span> 
