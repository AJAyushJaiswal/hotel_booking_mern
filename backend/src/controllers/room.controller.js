...
const addRoom = asyncHandler(async (req, res) => {
    ...
    const {name, description, type, pricePerRoom, totalQuantity, roomNumbers, capacityPerRoom, facilities} = req.body;
    ...
    const room = await Room.create({name, description, type, pricePerRoom, totalQuantity, quantityAvailable: totalQuantity, roomNumbers, capacityPerRoom, facilities, images: imageUrls, hotel: hotelId}).lean();
    if(!room){
